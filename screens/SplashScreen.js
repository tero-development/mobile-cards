        ...
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : null} style={{ flex: 1 }}>
            ...
            <View style={styles.pageBottom}>
                ...
                >
                        ...
                        <Title color={Colors.secondaryColor} textSize={converter(width/35, width/30, width/35, width/30)} style={{marginBottom: converter(width/30, width/30, width/30, width/30)}} >Tero International Inc.</Title>  
